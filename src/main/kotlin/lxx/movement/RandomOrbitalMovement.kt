...
import lxx.movement.mech.OrbitalMovement
import lxx.model.BattleField
import lxx.math.*
import lxx.movement.mech.OrbitDirection.STOP

class RandomOrbitalMovement(battleField: BattleField) {

    private var dir = randomDir()
    private var untilTick = randomUntilTick()
    private val orbitalMovement = OrbitalMovement(battleField, 300.0)
    ...
    fun getMovementDecision(battleState: BattleState): MovementDecision {
        ...
        return orbitalMovement.getMovementDecision(battleState.me, battleState.enemy, dir, RADIANS_45)
    }
